...
```
Las ANPs que conforman la región son: `r str_flatten(str_replace_all(mi_region_nombres$anp_nombres, "_", " "), ", ")`. 
...
La región `r mi_region` comprende las siguientes ecorregiones.
