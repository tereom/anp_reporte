...
Con el fin de mostrar tanto el nivel de integridad en cada estado como la 
variación en la integridad tomamos para cada estado una muestra aleatoria de 1000 
pixeles y construimos diagramas de los valores de integridad de los pixeles en 
la muestra. 

- La **mediana** de la integridad de los estados está representada por las líneas 
que dividen las cajas, si queremos pensar en un único valor para caracterizar la 
integridad de un estado podemos usar la mediana, con esto en mente los estados con mayor 
integridad ecosistémica son los primeros y conforme descendemos en la gráfica
disminuye la integridad.

- Los puntos **azules** representan la **mediana** de integridad en los anillos de
cada estado, esto nos sirve para comparar la integridad de cada estado con la 
