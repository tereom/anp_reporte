...
names(escala_color) <- c("otras", "anillo", "z.núcleo", "z.preservación",  
    mi_anp_corto)
escala_alpha <- c(0.1, 0.8, 0.8, 0.8, 1)
names(escala_alpha) <- c("otras", "anillo", "z.núcleo", "z.preservación",  
    mi_anp_corto)
# 
...
tasa_cambio_mi_anp_ring <- filter(tasa_cambio_cl, clase == "anillo")

tasa_cambio_plot <- ggplot(tasa_cambio_cl, aes(x = año, y = THH, group = ANP, 
    label = perdida_ha, color = clase, alpha = clase)) + 
    geom_line(aes(color = clase, alpha = clase)) +
    scale_alpha_manual(values = escala_alpha) +
    scale_color_manual(values = escala_color) +
...
names(escala_color_sin_anp) <- c("anillo", "z.núcleo", "z.preservación")
