...
<div data-includeHTML="logos.html"></div>
...
que genera un mapa con resolución espacial de 5 m^2^, construido a partir de 
imágenes Rapideye correspondientes al año 2015. Temáticamente se agregó para 
contar con 8 clases:  Bosque templado, Selva perennifolia, subperennifolia, caducifolia y subcaducifolia, Matorral, Vegetación menor y Pastizales, Tierras Agrícolas, Urbano y construido, Sin vegetación aparente (suelo desnudo) y Agua.
...
`r ifelse(puma, "
La siguiente gráfica nos muestra la distribución de la calidad de hábitat a lo largo de 
los años 2008 a 2014. Los puntos azules corresponden a la idoneidad de hábitat 
para el puma en la periferia circundante a la ANP.
", "")
