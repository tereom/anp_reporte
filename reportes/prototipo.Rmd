...
mi_anp_buffer_shp <- union(mi_anp_shp, mi_anp_ring_shp)
```
...
leaflet(data = mi_anp_buffer_shp) %>% 
...
hansen_mi_anp <- hansen_loss %>% 
    raster::crop(mi_anp_buffer_shp) %>%            # cortamos el raster a la dimensión del ANP
    mask(mask = mi_anp_buffer_shp)
